        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="space-y-8">
            ...
            <div class="bg-gradient-to-br from-slate-50/50 to-white rounded-3xl p-6 border border-slate-200/60">
              ...
              <div class="mt-6">
                <LanguageField v-model="form.description.ka" language="ka" label="🇬🇪 ქართული აღწერა" placeholder="ცენტრალური მდებარეობა მთავარ ქუჩაზე" :required="true" />
              </div>
            </div>
            <!-- English -->
            <div class="bg-gradient-to-br from-slate-50/50 to-white rounded-3xl p-6 border border-slate-200/60">
              ...
              <div class="mt-6">
                <LanguageField v-model="form.description.en" language="en" label="🇬🇧 English Description" placeholder="Central location on main street" :can-translate="!!form.description.ka" :translating="isTranslating" @translate="translateField('description', 'ka', 'en')" />
              </div>
            </div>
            <!-- Russian -->
            <div class="bg-gradient-to-br from-slate-50/50 to-white rounded-3xl p-6 border border-slate-200/60">
              ...
              <div class="mt-6">
                <LanguageField v-model="form.description.ru" language="ru" label="🇷🇺 русское описание" placeholder="Центральное расположение на главной улице" :can-translate="!!form.description.ka" :translating="isTranslating" @translate="translateField('description', 'ka', 'ru')" />
              </div>
            </div>
          </div>
        </div>
