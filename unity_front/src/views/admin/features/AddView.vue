  ...
  <div class="p-6">
    ...
    <div class="mb-8">
      <div class="flex items-center gap-4 mb-4">
        ...
        <h1 class="text-3xl font-bold text-gray-900">{{ t('admin.features.add_view_title') }}</h1>
      </div>
      <p class="text-gray-600">{{ t('admin.features.add_view_desc') }}</p>
    </div>
      ...
      <form @submit.prevent="submitForm" class="space-y-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                :placeholder="t('admin.features.feature_id_placeholder')"
              />
              <p class="text-xs text-gray-500 mt-1">{{ t('admin.features.feature_id_desc') }}</p>
            </div>
            <div>
              ...
              <input
                ...
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900"
              />
              <p class="text-xs text-gray-500 mt-1">{{ t('admin.features.sort_order_desc') }}</p>
            </div>
          </div>
          <div class="mt-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="space-y-8">
            ...
            <div class="bg-gradient-to-br from-slate-50/50 to-white rounded-3xl p-6 border border-slate-200/60">
              ...
              <div class="mt-6">
                <LanguageField v-model="form.description.ka" language="ka" :label="t('admin.features.desc_label_ka')" :placeholder="t('admin.features.placeholder_desc_ka')" :required="true" />
              </div>
            </div>
            <!-- English -->
            <div class="bg-gradient-to-br from-slate-50/50 to-white rounded-3xl p-6 border border-slate-200/60">
              ...
              <div class="mt-6">
                <LanguageField v-model="form.description.en" language="en" :label="t('admin.features.desc_label_en')" :placeholder="t('admin.features.placeholder_desc_en')" :can-translate="!!form.description.ka" :translating="isTranslating" @translate="translateField('description', 'ka', 'en')" />
              </div>
            </div>
            <!-- Russian -->
            <div class="bg-gradient-to-br from-slate-50/50 to-white rounded-3xl p-6 border border-slate-200/60">
              ...
              <div class="mt-6">
                <LanguageField v-model="form.description.ru" language="ru" :label="t('admin.features.desc_label_ru')" :placeholder="t('admin.features.placeholder_desc_ru')" :can-translate="!!form.description.ka" :translating="isTranslating" @translate="translateField('description', 'ka', 'ru')" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flex justify-end gap-4">
          ...
          <button type="submit" :disabled="isSubmitting" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2">
            ...
            {{ isSubmitting ? t('admin.features.creating') : t('admin.features.create_feature') }}
          </button>
        </div>
      </form>
    </div>
