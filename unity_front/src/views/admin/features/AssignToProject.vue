    ...
    <div v-if="selectedProjectId" class="bg-white rounded-lg shadow p-6">
      ...
      <div class="mb-6 p-4 bg-blue-50 rounded-lg">
        <label class="inline-flex items-center">
          ...
          <span class="ml-2 text-sm text-gray-700">ავტომატური გამოვლენა (პროექტის აღწერის მიხედვით)</span>
        </label>
      </div>
      ...
      <div v-if="!autoDetect" class="space-y-4">
        ...
        <div v-else-if="selectedFeatures.length > 0" class="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg">
          <div class="flex items-center gap-2">
            ...
            <span class="text-sm font-medium text-green-800">{{ selectedFeatures.length }} ფუნქცია მინიჭებულია ამ პროექტს</span>
          </div>
        </div>
