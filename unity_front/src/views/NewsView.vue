...
const filteredArticles = computed(() => {
  ...
  if (searchQuery.value.trim()) {
    articles = newsStore
      .searchArticles(searchQuery.value.trim(), 'ka')
      .filter(
        (article) =>
  ...
  <div class="min-h-screen bg-white">
    ...
    <section class="bg-zinc-900 py-24">
      <div class="max-w-7xl mx-auto px-4 md:px-8 text-center">
        <h1
          class="text-5xl md:text-6xl font-normal font-roboto text-white uppercase leading-tight tracking-[3px] mb-6"
        >
          სიახლეები
        </h1>
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-8 py-16">
      ...
      <!-- Featured Article -->
      <div
        v-else-if="featuredArticle && selectedCategory === 'all' && !searchQuery.trim()"
        class="mb-16"
      >
          ...
          <div class="md:flex">
            ...
            <div class="md:w-1/2 p-8">
              <div class="flex items-center gap-4 mb-4">
                ...
                <time class="text-zinc-600 text-sm">{{
      ...
      <div v-if="!isLoading">
        <div class="flex items-center justify-between mb-8">
          ...
          <span class="text-zinc-600"> {{ filteredArticles.length }} სტატია </span>
        </div>
          ...
          <div class="text-zinc-400 mb-4">
            <svg class="w-16 h-16 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                ...
                stroke-linejoin="round"
                stroke-width="2"
                d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.47-.881-6.084-2.327C7.412 15.959 9.405 18 12 18a7.96 7.96 0 005.084-1.827M15 8a3 3 0 11-6 0 3 3 0 016 0z"
              />
            </svg>
          </div>
          ...
          >
            <div class="relative overflow-hidden">
              ...
              <div class="absolute top-4 left-4">
                <span
                  class="px-3 py-1 bg-white/90 backdrop-blur-sm text-zinc-800 text-xs font-medium rounded-full"
                >
            ...
            <div class="p-6">
              ...
              <h3
                class="text-lg font-medium text-zinc-900 mb-3 line-clamp-2 group-hover:text-amber-600 transition-colors"
              >
                {{ article.title.ka }}
              </h3>
