 ...
 * Reusable SVG icon strings for contact information display
 */

export const contactIcons = {
  location: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
/**
 * Day name translations for office schedule
 */
export const dayTranslations: Record<string, Record<string, string>> = {
  ka: { Mon: 'ორშ', Tue: 'სამ', Wed: 'ოთხ', Thu: 'ხუთ', Fri: 'პარ', Sat: 'შაბ', Sun: 'კვი' },
